...
def read():
    ...
    return render_template('read_user.html', names=names)

@app.route('/delete-user/<int:user_if>', methods=['GET', 'POST'])
def delete_user(user_if):
    user = User.query.filter_by(user_if = user_if).first()
